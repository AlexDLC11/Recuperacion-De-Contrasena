...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'fidel.martinez198924@gmail.com', // Cambia esto a tu correo electrónico
    pass: 'qfyu ymns nrly hcuc', // Cambia esto a tu contraseña o contraseña de aplicación
  },
});
  ...
  try {
    db.query('SELECT * FROM users WHERE username = ?', [email], (err, results) => {
      ...
      if (user) {
        ...
        const mailOptions = {
          from: 'fidel.martinez198924@gmail.com', // Cambia esto a tu correo electrónico
          to: email,
