...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="card-title text-center text-danger mb-4">Iniciar sesión</h2>
        ...
        <div className="mt-3 text-center">
          <p>No tienes cuenta? <Link to="/register" className="text-info">Registrate aqui</Link></p>
          <p>Olvidaste tu contraeña?<Link to="/forgot-password" className="text-info">Recuperala</Link></p>
        </div>
      </div>
